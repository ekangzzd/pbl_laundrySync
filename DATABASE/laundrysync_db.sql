...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 25, 2025 at 08:31 AM
...
CREATE TABLE `laundrydetails_tbl` (
  ...
  `totalProcessingTime` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `laundrydetails_tbl` (`details_id`, `service_id`, `washLoad_id`, `dryLoad_id`, `totalProcessingTime`) VALUES
(1, 1, 1, NULL, 21),
(2, 1, 2, NULL, 21),
(3, 1, 3, NULL, 21),
(4, 1, 4, NULL, 28),
...
(2, 1, '2025-02-25 10:00:00', 'cash', 95.00, NULL, 0.00, 95.00, '2025-02-25 07:09:50', '2025-02-25 07:09:50');
